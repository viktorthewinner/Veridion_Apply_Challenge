...
- Main method:
  I am using a pre-trained LLM, I am the going to fine-tune (manually/supervised)
  Pro points:
  -> we could have better answers

  Con points:
  -> we are not going full auto

- Second method:
  The first method I built, checking my knowledge/tutorials/AI. I wrote some strong comments in the code also. I can say as well as you that it is a cheap version, not classy.
